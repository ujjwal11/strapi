...
const AuthPage = ({ hasAdmin }) => {
  ...
  //     const data = await axios.get(`http://demo7512624.mockable.io/login`)
  //     // console.log('aaaaaaaccccaa>>',data)

  //     auth.setToken(data.data.updatedToken, modifiedData.rememberMe);
  //     auth.setUserInfo(data.data.updatedUser, modifiedData.rememberMe);
  //     push('/')
  //   }
    
  //   // getUpdatedData()
  //   getUpdatedData()
  //   // auth.setToken(updatedToken, modifiedData.rememberMe);
  //   // auth.setUserInfo(updatedUser, modifiedData.rememberMe);
  ...
  const loginRequest = async (body, requestURL) => {
    ...
    //   ]
    // }
    // const updatedToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjA0NDgwNzc5LCJleHAiOjE2MDcwNzI3Nzl9.0EDsZ2r8_SCSeJmkim4p9bRbLVKuIlTmJgINCgqjTXo"
    try {
      ...
      // console.log('asdasdasd>>>',`${strapi.backendURL}${requestURL}`)
      // console.log('modifiedDatamodifiedData>>>', modifiedData.rememberMe)
      // console.log('tokentoken>>>', token)
      // console.log('useruser>>>', user)
      console.log('useruser>>>', data)


      auth.setToken(data.data.updatedToken.en, modifiedData.rememberMe);
      auth.setUserInfo(data.data.updatedUser.data, modifiedData.rememberMe);
