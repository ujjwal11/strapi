...
function ListView({
  ...
  const listLayout = useMemo(() => {
    console.log(">>>>>>>>>>> check", (layouts, [...contentTypePath, 'layouts', 'list'], []))
    console.log("contentTypePath check", contentTypePath)
    console.log(">layouts check", layouts)
  ...
  console.log(">listSchema check", label)

  const tableHeaders = useMemo(() => {
    console.log('listLayoutlistLayout>>', listLayout)
    ...
    if (hasDraftAndPublish) {
      // console.log('hasDraftAndPublish',hasDraftAndPublish)
      // console.log('getMetaDatas',getMetaDatas)
      ...
      headers.push({
        ...
        cellFormatter: cellData => {
          ...
          // console.log("isPublished >> isPublished>>", isPublished)

          return <State isPublished={isPublished} />;
        },
      });
    }
    console.log("headers in return", headers)
    return headers;
  ...
  console.log('listLayout > li >', listLayout)
